...
<script>
  import { required, email, numeric, minValue, minLength, sameAs, requiredUnless, alpha ,maxLength} from 'vuelidate/lib/validators'
...
//                        })
      ...
      phone:{
          required,
          numeric
//            sameAs: sameAs("/^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/")
      },
      dateOfBirth:{
          required,
          unique:dateOfBirth=>{
